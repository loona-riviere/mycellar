            ...
            <form action={formAction} className="grid grid-cols-1 gap-4 bg-white p-5 rounded-lg border shadow-sm">
                <div>
                    ...
                    <input name="name" required className="mt-1 w-full rounded-md border px-3 py-2 text-sm"
                        placeholder="Ex: Bourgogne Pinot Noir" />
                </div>

                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium">Producteur</label>
                        <input name="producer" className="mt-1 w-full rounded-md border px-3 py-2 text-sm"
                            placeholder="Domaine…" />
                    </div>
                    <div>
                        <label className="block text-sm font-medium">Région</label>
                        <input name="region" className="mt-1 w-full rounded-md border px-3 py-2 text-sm"
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium">Bue ?</label>
                        <input type="checkbox" name="consumed" className="mt-2 h-4 w-4" />
                    </div>
                    <div>
                ...
                <div>
                    ...
                    <textarea name="comm" rows={3} className="mt-1 w-full rounded-md border px-3 py-2 text-sm"
