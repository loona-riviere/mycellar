    ...
    return (
        <main className="max-w-2xl mx-auto p-6">
            ...
            <form action={formAction} className="grid grid-cols-1 gap-4 bg-white p-5 rounded-lg border shadow-sm">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div>
                        <label className="block text-sm font-medium">À boire entre le (année)</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium">et le (année)</label>
